...
export class ProductsComponent implements OnInit {
  ...
  new Product(3,"Caramel",130, 1,"https://djftrby1k8irl.cloudfront.net/s3fs-public/2022-02%2FCaramel%20Macchiato%20425x425%20verde_1.png?auto=format,compress&q=70&crop=focalpoint&ar=1:1.0&w=180&fit=crop", "coffee")
